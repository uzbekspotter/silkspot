...
- **2026-04-06** — **Профиль споттера:** убран градиент **transparent → #fff** над обложкой; верх страницы на **`#f8fafc`** как полоса статистики; без своей обложки — компактная полоса 120px; с обложкой — фото 200px, без «выцветания» в белый (`opacity` 0.85). Файл: `ProfilePage.tsx`. Коммит: `PENDING`.
