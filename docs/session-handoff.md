...
- **2026-04-06** — **Auth мобилка:** убраны **герой + маркетинг + Мрия** над формой и **SkyWave-шапка** на входе; на узких экранах снова **только форма** (`hidden lg:flex` для левой колонки). Файл: `AuthPage.tsx`.
