...
- **2026-04-06** — **Страница фото:** убраны дублирующие сайдбар-блоки «Aircraft quick info» и «Location» (те же данные и клики уже в основной сетке); в колонке остаётся карточка автора. Файл: `src/components/PhotoDetailPage.tsx`.
