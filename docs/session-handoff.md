...
- **2026-04-06** — **Explore (главная):** убран блок **Spotters today** (аватарки + RPC `top_spotters_today`); меньше верхний `padding` и отступы секций — **лента и Latest uploads выше**. Файл: `ExplorePage.tsx`. Коммит: `PENDING`.
